...
rocker ${opts} --x11 --devices /dev/dri --user --net host --privileged --name "aichallenge-2026-$(date "+%Y-%m-%d-%H-%M-%S")" --volume ${volume} -- "aichallenge-2026-${target}" 2>&1 | tee "$LOG_FILE"
